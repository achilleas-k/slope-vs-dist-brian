...
inter_packet_interval = 20*ms
packet_sequence = []
packet_sequence.append({"spread": rand()*ms, "t": 50*ms, "n": Nin})
for spr in reversed(repeat(frange(0, 10, 0.1), 10)):
...
savefig("plots/clean_results.png")
